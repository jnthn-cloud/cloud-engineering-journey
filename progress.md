...
## Next: Day 4 — Save logs to JSON + intro to boto3 (AWS SDK)
...
## Next: Day 5 — AWS CLI setup + first cloud commands
...
## Next: Day 6 — First S3 bucket + upload health logs to cloud
